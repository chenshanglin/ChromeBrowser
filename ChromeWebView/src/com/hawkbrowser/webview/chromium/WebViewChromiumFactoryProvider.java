...
import com.hawkbrowser.webkit.WebIconDatabase;
import com.hawkbrowser.webkit.WebStorage;
import com.hawkbrowser.webkit.WebView;
import com.hawkbrowser.webkit.WebViewDatabase;
import com.hawkbrowser.webkit.WebViewFactoryProvider;
import com.hawkbrowser.webkit.WebViewProvider;
...
public class WebViewChromiumFactoryProvider implements WebViewFactoryProvider {
    ...
    private void startChromiumLocked() {
        ...
        if (mApplicationContext.getApplicationInfo().targetSdkVersion < Build.VERSION_CODES.KITKAT) {
        ...
        synchronized (mLock) {
            if (mCookieManager == null) {
                if (!mStarted) {
                    ...
                    ContentMain.initApplicationContext(mApplicationContext);
                }
